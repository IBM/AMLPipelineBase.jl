...
function fit!(ohe::OneHotEncoder, myinstances::DataFrame, ::Vector=[])::Nothing
...
function fit!(::Imputer, ::DataFrame, ::Vector=[])::Nothing
  nothing
end

function fit(imp::Imputer, ::DataFrame, ::Vector=[])::Imputer
  return imp
end
